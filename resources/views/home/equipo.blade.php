...
@section('content') 
    ...
    <li>
      ...
      <li>
        <img src="images/equipo/rox.jpg"> <!-- random image -->
        <div class="caption left-align">
            <h3 class="oswaldo">Lic. Roxana Mendoza</h3>
            <h5 class="light grey-text text-lighten-3 thin">"Soy entrenadora de Gimnasia, lo que gusta de la gimnasia es la disciplina con la que se tiene que aplicar, tiene que ser exacta y lo bonito es que un ejercicio bien hecho es estético, elegante..."</h5>
        </div>
      </li>

      <li>
          <img src="images/equipo/xavi2.jpg"> <!-- random image -->
          <div class="caption left-align">
      ...
      <li>
        <img src="images/equipo/lehi.jpg"> <!-- random image -->
        <div class="caption left-align">
            <h3 class="oswaldo">Pedro Lehi Matus</h3>
            <h5 class="light grey-text text-lighten-3 thin">"Entrenador y gimnasta. No lo considero como un simple deporte, es superarte día a día y enfrentar tus miedos."</h5>
        </div>
      </li>

      <li>
        <img src="images/equipo/marlene.jpg"> <!-- random image -->
        <div class="caption left-align">
            <h3 class="oswaldo">Lic. Marlene Matus</h3>
            <h5 class="light grey-text text-lighten-3 thin">"Siempre atenta en recepción, sera un placer servirle."</h5>
        </div>
      </li>
      

  <li>
    <img src="images/equipo/brayan.jpg"> <!-- random image -->
    <div class="caption left-align">
        <h3 class="oswaldo">Lic. Brayam Aguilar Mora</h3>
        <h5 class="light grey-text text-lighten-3 thin">"Disfruto del progreso de mis alumnos y motivarlos para adoptar la filosofía de superación"</h5>
    </div>
  </li>

<li>
  <img src="images/equipo/valeria.jpg"> <!-- random image -->
  <div class="caption left-align">
      <h3 class="oswaldo">Lic. Valeria Gonzalez</h3>
      <h5 class="light grey-text text-lighten-3 thin">"La gimnasia es un deporte que le exige a tu cuerpo adaptación, consistencia y sobre todo mucha adrenalina."</h5>
  </div>
</li>

<li>
  <img src="images/equipo/luis.jpg"> <!-- random image -->
  <div class="caption left-align">
      <h3 class="oswaldo">Luis Eduardo Cundapi</h3>
      <h5 class="light grey-text text-lighten-3 thin">"Aunque la gimnasia es un deporte de competencia, yo lo veo mas enfocado a una constante competencia con uno mismo."</h5>
  </div>
</li>
